"""引用：https://leetcode.com/problems/consecutive-numbers-sum/discuss/129015/5-lines-C-solution-with-detailed-mathematical-explanation
...
class Solution:
    def consecutiveNumbersSum(self, N):
        ...
        for k in range(2, int(math.sqrt(N*2))+1):
            # the sequence is x,x+1, x+2, x+3, x+4,...,k
            if( N - k * (k-1) / 2) % k == 0:
                counter += 1
        return counter